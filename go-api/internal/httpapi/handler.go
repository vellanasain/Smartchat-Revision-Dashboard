...
func (h *Handler) Routes() http.Handler {
	...
	mux.HandleFunc("GET /api/revision-projects", h.listRevisionProjects)
	mux.HandleFunc("GET /api/revision-projects/{id}", h.getRevisionProject)
	mux.HandleFunc("POST /api/revision-projects", h.notImplemented)
	mux.HandleFunc("PATCH /api/revision-projects/{id}", h.notImplemented)
	mux.HandleFunc("GET /api/revision-projects/{id}/cycles", h.notImplemented)
	mux.HandleFunc("POST /api/revision-projects/{id}/cycles", h.notImplemented)
	mux.HandleFunc("PATCH /api/revision-cycles/{id}/stage", h.notImplemented)
	mux.HandleFunc("PATCH /api/revision-cycles/{id}/work-status", h.notImplemented)
	mux.HandleFunc("POST /api/payment-transactions", h.notImplemented)
	mux.HandleFunc("GET /api/dashboard/stats", h.notImplemented)
